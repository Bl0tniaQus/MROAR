...
train_dirs = ["images/dzien_zima"];
test_dirs = ["images/noc_jesien", "images/noc_wiosna", "images/noc_zima", "images/dzien_jesien", "images/dzien_wiosna"];
