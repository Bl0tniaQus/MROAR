...
train_dirs = ["images/noc_jesien"];
test_dirs = ["images/dzien_jesien", "images/dzien_wiosna", "images/dzien_zima", "images/noc_wiosna", "images/noc_zima"];
